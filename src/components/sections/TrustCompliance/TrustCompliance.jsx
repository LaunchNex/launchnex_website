...
const COMPLIANCE_CARDS = [
  {
    ...
    items: [
      ...
      'Regular security reviews & testing',
  ...
  },
  {
    ...
    items: [
      ...
      'Color contrast & usability standards',
  ...
  },
  {
    ...
    items: [
      ...
      'Compliance checklist in every release',
    ],
  },
];
  ...
  return (
    <section className={styles.section}>
      <div className={styles.inner}>
        ...
        >
          <SectionLabel><ShieldCheck size={14} style={{ marginRight: 6, verticalAlign: '-2px' }} />Trust & Compliance</SectionLabel>
          <h2 className={styles.title}>
            Built for production.{' '}
            <span className={styles.titleBreak}>Trusted for <span className={styles.accent}>compliance.</span></span>
          </h2>
          ...
          {TRUST_BADGES.map(({ icon: Icon, gdpr, title, subtitle }) => (
            <div key={title} className={styles.badge}>
              <span className={styles.badgeIcon}>
                {gdpr ? <GdprIcon /> : <Icon size={26} strokeWidth={1.5} />}
              </span>
        ...
        >
          ...
          <p className={styles.subSubtitle}>
            From architecture to deployment, we follow industry standards and best practices to deliver solutions that are secure, inclusive, and compliant.
          </p>
        </motion.div>
          ...
          {COMPLIANCE_CARDS.map(({ icon: Icon, title, items }, i) => (
            ...
            >
              <div className={styles.cardHeader}>
                <span className={styles.cardIcon}><Icon size={24} strokeWidth={1.5} /></span>
        ...
        >
          <div className={styles.ctaInner}>
            <div className={styles.ctaLeft}>
              <span className={styles.ctaIconWrap}><ShieldCheck size={20} strokeWidth={1.5} /></span>
