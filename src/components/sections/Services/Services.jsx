...
const CATEGORIES = [
	{
		...
		description: "From custom LLM applications and autonomous agents to RAG pipelines and workflow automation — we build production-grade AI that solves real business problems.",
	...
	},
	{
		...
		description: "Web apps, mobile apps, and AI-enabled products — built with React, Next.js, and React Native. Every interface is pixel-perfect, performant, and designed to scale.",
	...
	},
	{
		...
		description: "User research, wireframes, interactive prototypes, and design systems. We create intuitive, visually polished interfaces grounded in modern design principles.",
		badges: ["UI/UX Design", "User Research", "Prototyping", "Design Systems"],
	},
	{
		title: "Consulting & Support",
		hook: "Clarity before code. Confidence after launch.",
		description: "AI strategy and feasibility assessments, rigorous QA and testing, and ongoing maintenance — so you build the right thing, ship with confidence, and stay running.",
			...
			<div className={styles.inner}>
				<MotionDiv className={styles.header}>
					...
					<h2 className={styles.title}>
						Full-spectrum <span className={styles.accent}>AI engineering.</span>
					</h2>
					...
					{CATEGORIES.map((category, i) => (
						<MotionDiv
							...
							<span className={styles.cardIcon}>
								{(() => {
									const { Icon, color } = CARD_ICONS[i];
									return <Icon size={28} color={color} strokeWidth={1.5} />;
								})()}
							</span>
