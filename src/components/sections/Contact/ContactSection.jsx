	...
	return (
		<section className={styles.section}>
			<div className={styles.inner}>
				<MotionDiv className={styles.grid}>
					{/* Left column */}
					<div className={styles.info}>
						<h2 className={styles.title}>Or tell us everything here.</h2>
						<p className={styles.body}>Prefer a detailed brief? Fill out this form and we'll review your challenge before booking a call. The more context, the better our first conversation.</p>
						...
						{formState === "success" ? (
							...
							<form onSubmit={handleSubmit(onSubmit)} className={styles.form} noValidate>
								...
								<div className={styles.field}>
									...
									{errors.source && (
										<span id="source-error" className={styles.error} role="alert">
