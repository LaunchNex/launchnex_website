      ...
      <div className={styles.inner}>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className={styles.header}>
          ...
          <h2 className={styles.heading}>
            AI engineering partner.<br />
            <span className={styles.accent}>Not just a vendor.</span>
          </h2>
          <p className={styles.subtitle}>We take ownership, reduce risk, and deliver AI systems<br />that create real business impact.</p>
        </motion.div>

        {/* Feature Cards */}
        <div className={styles.cards}>
          {CARDS.map(({ icon: Icon, title, description }, i) => (
            <motion.div key={title} custom={i} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className={styles.card}>
              <div className={styles.cardIconWrap}><Icon size={24} strokeWidth={1.5} /></div>
        ...
        {/* CTA */}
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className={styles.cta}>
          <div className={styles.ctaLeft}>
            <span className={styles.ctaIconWrap}><CalendarCheck size={22} strokeWidth={1.5} /></span>
            <div>
          ...
          <div className={styles.ctaButtons}>
            <Button to="/contact" variant="primary">Validate your AI idea</Button>
          </div>
        </motion.div>
      </div>
    </section>
