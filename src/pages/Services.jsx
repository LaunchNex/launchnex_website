    ...
    services: [
      {
        ...
        capabilities: [
          ...
          'Content generation & summarization pipelines',
          'AI-assisted internal tools & workflows',
        ],
      },
      {
        ...
        capabilities: [
          ...
          'Internal IT/HR helpdesk agents',
        ],
      },
      {
        ...
        capabilities: [
          ...
          'CRM & helpdesk system connectivity',
        ],
      },
      {
        ...
        capabilities: [
          'Document ingestion & embedding pipelines',
      ...
      },
      {
        ...
        capabilities: [
          'Production prompt design & optimization',
          'AI output evaluation frameworks',
          'Cost & token efficiency tuning',
        ],
      },
      {
        ...
        capabilities: [
          'LangChain agent & chain development',
          'LlamaIndex data retrieval pipelines',
    ...
    services: [
      {
        ...
        capabilities: [
          ...
          'AI-integrated landing pages & portals',
          'SEO-optimized, fast-loading architecture',
        ],
      },
      {
        ...
        capabilities: [
          ...
          'Component library & design system setup',
          'Performance optimization & code quality audits',
        ],
      },
      {
    ...
    services: [
      ...
      },
      {
        ...
        capabilities: [
          ...
          '30/60/90-day post-launch support plans',
        ],
      },
    ],
  },
...
export default function ServicesPage() {
  return (
    <>
      <Helmet>
        <title>Services — LaunchNex</title>
        <meta name="description" content="AI development, application engineering, UI/UX design, and consulting — 15 services across 4 capability areas from LaunchNex." />
        <meta property="og:title" content="Services — LaunchNex" />
        <meta property="og:description" content="Full-spectrum AI engineering. 15 services across 4 capability areas." />
        <meta property="og:url" content="https://launchnex.dev/services" />
        <link rel="canonical" href="https://launchnex.dev/services" />
      </Helmet>

      <div className={styles.page}>
        {/* Page hero */}
        <section className={styles.hero}>
          <motion.div variants={fadeUp} initial="hidden" animate="visible" className={styles.heroContent}>
            <SectionLabel>Our Services</SectionLabel>
            <h1 className={styles.heroTitle}>Full-spectrum AI engineering.</h1>
            <p className={styles.heroBody}>
              From strategy to design to development to long-term support — 15 services across 4 capability areas, delivered by senior engineers with 12+ years of experience. No juniors. No handoffs. No shortcuts.
            </p>
          </motion.div>
        </section>
